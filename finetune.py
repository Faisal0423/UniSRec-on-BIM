...
def finetune(dataset, pretrained_file, fix_enc=True, **kwargs):
    ...
    # configurations initialization
    config = Config(model=UniSRec, dataset=dataset, config_file_list=props, config_dict=kwargs) #Kwargs provide a flexible way to pass optional information along with regular arguments
...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', type=str, default='Allplan', help='dataset name')
